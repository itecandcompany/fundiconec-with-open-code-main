...
const en = {
  ...
  "account.about": "About",
  "account.aboutEmpty": "Add a short bio so clients know who they're hiring.",
  "account.contactInfo": "Contact information",
  "account.email": "Email",
  "account.activity": "Activity",
  "account.jobHistory": "Job history",
  "account.supportLegal": "Support & legal",
...
const sw: Record<TKey, string> = {
  ...
  "account.aboutEmpty": "Ongeza maelezo mafupi ili wateja wajue wanamwajiri nani.",
  "account.contactInfo": "Taarifa za mawasiliano",
  "account.email": "Barua pepe",
  "account.activity": "Shughuli",
  "account.jobHistory": "Historia ya kazi",
  "account.supportLegal": "Msaada na sheria",
  "account.helpCenter": "Kituo cha msaada",
